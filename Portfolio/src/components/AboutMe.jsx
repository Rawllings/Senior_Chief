...
function AboutMe() {
  return (
    <div>
      {/* IMAGE  */}
      <div>
        <img src={devPhoto} alt="developer cartoon image" />
      </div>
      {/* DESCRIPTION  */}
      <div>
        <p>
          I am Rawllings Kiprop, a dedicated and versatile software developer
          with expertise in both front-end and back-end development. My passion
          for creating intuitive and engaging digital experiences drives me to
          deliver high-quality solutions for diverse projects. With a strong
          background in graphic design and UI/UX, I bring a unique blend of
          technical proficiency and creative flair to every project I undertake.
        </p>
